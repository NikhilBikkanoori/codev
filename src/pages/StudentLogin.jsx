        ...
        <div style={{ background: '#262C53', borderRadius: '12px', width: '100%', maxWidth: '400px', boxShadow: '0 6px 18px rgba(0,0,0,0.1)', padding: '2rem' }}>
          ...
          <form onSubmit={handleLogin}>
            <div style={{ marginBottom: '1rem' }}>
              ...
              <input type="text" placeholder="Enter your student ID" style={{ width: '100%', color:'black',padding: '0.75rem', border: '1px solid #ccc', borderRadius: '6px', fontSize: '1rem', boxSizing: 'border-box' }} required />
            </div>
